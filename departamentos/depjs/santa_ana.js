const departmentData = {    
    "Santa Ana": {
        mapImage: "../img/dep/santaana.png",
        title: "Información sobre Santa Ana",
        description: [
            "Santa Ana es un departamento de El Salvador ubicado en la zona occidental del país. Es conocido por su rica historia, arquitectura colonial y el majestuoso volcán de Santa Ana."
        ],
        carouselImages: [
            "../img/carusel/santaana4.jpg",
            "../img/carusel/santaana1.jpg",
            "../img/carusel/santaana3.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/santaana1.jpg", nombre: "Volcán de Santa Ana" },
            { img: "../img/carusel/santaana2.jpg", nombre: "Teatro de Santa Ana" },
            { img: "../img/carusel/santaana3.jpg", nombre: "Lago de Coatepeque" }
        ]
    },
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const departmentName = "Santa Ana";
