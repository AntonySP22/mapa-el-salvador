const departmentData = {    
    "La Unión": {
        mapImage: "../img/dep/union.png",
        title: "Información sobre La Unión",
        description: [
            "La Unión es un departamento de El Salvador ubicado en la zona oriental del país. Es conocido por su puerto en el Golfo de Fonseca, sus playas paradisíacas, y por ser un importante punto de comercio marítimo."
        ],
        carouselImages: [
            "../img/carusel/launion4.jpg",
            "../img/carusel/launion1.jpg",
            "../img/carusel/launion2.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/launion1.jpg", nombre: "Golfo de Fonseca" },
            { img: "../img/carusel/launion2.jpg", nombre: "Playa Las Tunas" },
            { img: "../img/carusel/launion3.jpg", nombre: "Isla Meanguera" }
        ]
    },
};
