const departmentData = {    
    "Sonsonate": {
        mapImage: "../img/dep/sonsonate.png",
        title: "Información sobre Sonsonate",
        description: [
            "Sonsonate es un departamento de El Salvador ubicado en la zona occidental del país. Es conocido por su riqueza cultural, bellas playas y el famoso recorrido turístico de la Ruta de las Flores."
        ],
        carouselImages: [
            "../img/carusel/sonsonate4.jpg",
            "../img/carusel/sonsonate2.jpg",
            "../img/carusel/sonsonate3.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/sonsonate1.jpg", nombre: "Ruta de las Flores" },
            { img: "../img/carusel/sonsonate2.jpg", nombre: "Puerto de Acajutla" },
            { img: "../img/carusel/sonsonate3.jpg", nombre: "Izalco" }
        ]
    },
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const departmentName = "Sonsonate";
