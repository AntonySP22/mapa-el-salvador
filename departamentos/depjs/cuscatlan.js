const departmentData = {    
    "Cuscatlán": {
        mapImage: "../img/dep/cusca.png",
        title: "Información sobre Cuscatlán",
        description: [
            "Cuscatlán es un departamento de El Salvador ubicado en la zona central del país. Es conocido por su rica historia precolombina, así como por su producción agrícola, especialmente de café y caña de azúcar."
        ],
        carouselImages: [
            "../img/carusel/cuscatlan4.jpg",
            "../img/carusel/cuscatlan2.jpg",
            "../img/carusel/cuscatlan1.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/cuscatlan1.jpg", nombre: "Suchitoto" },
            { img: "../img/carusel/cuscatlan2.jpg", nombre: "Lago Suchitlán" },
            { img: "../img/carusel/cuscatlan3.jpg", nombre: "Cojutepeque" }
        ]
    },
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const departmentName = "Cuscatlán";
