const departmentData = {    
    "La Paz": {
        mapImage: "../img/dep/lapaz.png",
        title: "Información sobre La Paz",
        description: [
            "La Paz es un departamento de El Salvador ubicado en la zona central del país, a lo largo de la costa del océano Pacífico. Es conocido por sus playas, agricultura y la producción de sal en las salinas de la Bahía de Jiquilisco."
        ],
        carouselImages: [
            "../img/carusel/lapaz4.jpg",
            "../img/carusel/lapaz2.jpg",
            "../img/carusel/lapaz1.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/lapaz1.jpg", nombre: "Costa del Sol" },
            { img: "../img/carusel/lapaz3.jpg", nombre: "San Antonio Masahuat" },
            { img: "../img/carusel/lapaz2.jpg", nombre: "Playa Los Blancos" }
        ]
    },
};
