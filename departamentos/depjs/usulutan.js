const departmentData = {    
    "Usulután": {
        mapImage: "../img/dep/usulu.png",
        title: "Información sobre Usulután",
        description: [
            "Usulután es un departamento de El Salvador ubicado en la zona oriental del país. Es conocido por su agricultura, playas hermosas, y la Bahía de Jiquilisco, un importante estuario y área de conservación natural."
        ],
        carouselImages: [
            "../img/carusel/usulutan4.jpg",
            "../img/carusel/usulutan2.jpg",
            "../img/carusel/usulutan3.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/usulutan1.jpg", nombre: "Bahía de Jiquilisco" },
            { img: "../img/carusel/usulutan2.jpg", nombre: "Laguna de Alegría" },
            { img: "../img/carusel/usulutan3.jpg", nombre: "El Espino" }
        ]
    },
};
