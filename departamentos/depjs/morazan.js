const departmentData = {    
    "Morazán": {
        mapImage: "../img/dep/morazan.png",
        title: "Información sobre Morazán",
        description: [
            "Morazán es un departamento de El Salvador ubicado en la zona oriental del país. Es conocido por su historia durante el conflicto armado, sus paisajes montañosos, y sitios históricos como el Museo de la Revolución en Perquín."
        ],
        carouselImages: [
            "../img/carusel/morazan4.jpg",
            "../img/carusel/morazan2.jpg",
            "../img/carusel/morazan3.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/morazan1.jpg", nombre: "Museo de la Revolución en Perquín" },
            { img: "../img/carusel/morazan2.jpg", nombre: "Cascada El Chorrerón" },
            { img: "../img/carusel/morazan3.jpg", nombre: "Cerro El Pericón" }
        ]
    },
};
