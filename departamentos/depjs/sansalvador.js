const departmentData = {    
    "San Salvador": {
        mapImage: "../img/dep/sansivar.png",
        title: "Información sobre San Salvador",
        description: [
            "San Salvador, la capital de El Salvador, es una ciudad vibrante situada en el corazón del país. Fundada en 1525 por los colonizadores españoles, ha evolucionado a lo largo de los siglos para convertirse en el principal centro político, económico y cultural de El Salvador. Con una población diversa y dinámica, San Salvador juega un papel crucial en la vida nacional."
        ],
        carouselImages: [
            "../img/carusel/sansalvador1.jpg",
            "../img/carusel/sansalvador2.jpg",
            "../img/carusel/sansalvador3.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/sansalvador1.jpg", nombre: "San Salvador" },
            { img: "../img/carusel/sansalvador2.jpg", nombre: "Centro Histórico" },
            { img: "../img/carusel/sansalvador3.jpg", nombre: "Monumento al Salvador del Mundo" }
        ]
    },
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const departmentName = "San Salvador"; // Nombre del departamento que quieres mostrar
