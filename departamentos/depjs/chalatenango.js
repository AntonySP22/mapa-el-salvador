const departmentData = {    
    "Chalatenango": {
        mapImage: "../img/dep/Chalate.png",
        title: "Información sobre Chalatenango",
        description: [
            "Chalatenango es un departamento de El Salvador ubicado en la zona norte del país. Es conocido por sus impresionantes paisajes montañosos, ríos y su cultura agrícola, así como por ser un destino popular para el ecoturismo."
        ],
        carouselImages: [
            "../img/carusel/chalatenango3.jpg",
            "../img/carusel/chalatenango2.jpeg",
            "../img/carusel/chalatenango4.jpg"
        ],
        municipios: [
            "Agua Caliente", "Arcatao", "Azacualpa", "Citalá", "Comalapa", "Concepción Quezaltepeque", "Dulce Nombre de María", "El Carrizal", "El Paraíso", "La Laguna", "La Palma", "La Reina", "Las Vueltas", "Nueva Concepción", "Nueva Trinidad", "Ojos de Agua", "Potonico", "San Antonio de la Cruz", "San Antonio Los Ranchos", "San Fernando", "San Francisco Lempa", "San Francisco Morazán", "San Ignacio", "San Isidro Labrador", "San José Cancasque", "San José Las Flores", "San Luis del Carmen", "San Miguel de Mercedes", "San Rafael", "Santa Rita", "Tejutla"
        ],
        lugaresTuristicos: [
            { img: "../img/carusel/chalatenango1.jpg", nombre: "La Palma" },
            { img: "../img/carusel/chalatenango2.jpeg", nombre: "Cerro El Pital" },
            { img: "../img/carusel/chalatenango4.jpg", nombre: "Embalse Cerrón Grande" }
        ]
    },
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const departmentName = "Chalatenango";
