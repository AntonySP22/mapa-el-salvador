const departmentData = {    
    "San Vicente": {
        mapImage: "../img/dep/sanvicente.png",
        title: "Información sobre San Vicente",
        description: [
            "San Vicente es un departamento de El Salvador ubicado en la zona central del país. Es conocido por su volcán Chichontepec, también llamado Volcán de San Vicente, así como por su agricultura y tradiciones culturales."
        ],
        carouselImages: [
            "../img/carusel/sanvicente1.jpg",
            "../img/carusel/sanvicente2.jpg",
            "../img/carusel/sanvicente3.jpg"
        ],
        municipios: [
        ...
        lugaresTuristicos: [
            { img: "../img/carusel/sanvicente1.jpg", nombre: "Volcán Chichontepec" },
            { img: "../img/carusel/sanvicente2.jpg", nombre: "Laguna de Apastepeque" },
            { img: "../img/carusel/sanvicente3.jpg", nombre: "Parque Recreativo Amapulapa" }
        ]
    },
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const departmentName = "San Vicente";
