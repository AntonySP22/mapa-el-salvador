const departmentData = {    
    "Cabañas": {
        mapImage: "../img/dep/cabañas.png",
        title: "Información sobre ¿Cabañas?",
        description: [
            "Cabañas es un departamento de El Salvador ubicado en la zona norte-central del país. Es conocido por su belleza natural, sitios arqueológicos y por su importancia en la producción de minerales y agricultura."
        ],
        carouselImages: [
            "../img/carusel/cabanas1.jpg",
            "../img/carusel/cabanas2.jpg",
            "../img/carusel/cabanas3.jpg"
        ],
        municipios: [
            "Cinquera", "Dolores", "Guacotecti", "Ilobasco", "Jutiapa", "San Isidro", "Sensuntepeque", "Tejutepeque", "Victoria"
        ],
        lugaresTuristicos: [
            { img: "../img/carusel/cabanas1.jpg", nombre: "Ilobasco" },
            { img: "../img/carusel/cabanas2.jpg", nombre: "Cerro de Guazapa" },
            { img: "../img/carusel/cabanas3.jpg", nombre: "Parque Nacional Cinquera" }
        ]
    },
};
