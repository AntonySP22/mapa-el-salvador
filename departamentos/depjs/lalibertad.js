const departmentData = {    
    "La Libertad": {
        mapImage: "../img/dep/lalibertad.png",
        title: "Información sobre La Libertad",
        description: [
            "La Libertad es un departamento de El Salvador que se encuentra en la zona central del país. Es conocido por sus hermosas playas, zonas turísticas y proximidad a la capital, San Salvador",
        ],
        carouselImages: [
            "../img/carusel/lalibertdad1.jpg",
            "../img/carusel/lalibertdad2.jpg",
            "../img/carusel/lalibertdad3.jpg"
        ],
        municipios: [
            "Antiguo Cuscatlán", "Chiltiupán", "Ciudad Arce", "Colón", "Comasagua", "Huizúcar", "Jayaque", "Jicalapa", "La Libertad", "Nuevo Cuscatlán", "Quezaltepeque", "San José Villanueva", "San Juan Opico", "Sacacoyo", "San Matías", "San Pablo Tacachico", "Talnique", "Tamanique", "Teotepeque", "Tepecoyo", "Zaragoza"
        ],
        lugaresTuristicos: [
            { img: "../img/carusel/lalibertdad1.jpg", nombre: "La Libertad" },
            { img: "../img/carusel/lalibertdad2.jpg", nombre: "Santa Tecla" },
            { img: "../img/carusel/lalibertdad3.jpg", nombre: "Ruinas de San Andres" }
        ]
    },
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const departmentName = "La Libertad";
